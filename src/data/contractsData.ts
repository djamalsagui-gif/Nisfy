...
export const INITIAL_NISFY_CONTRACTS: NisfyContract[] = [
  ...
  {
    id: 'ctr-mirou-diner-2026',
    contractNumber: 'CTR-2026-NISFY-MR01',
    contractType: 'advertising_sponsor',
    contractTypeLabel: 'Contrat Sponsor Officiel & Chef à Domicile',
    contractTypeLabelAr: 'عقد رعاية رسمية وشيف منزلي خاص',
    title: 'Convention de Partenariat & Diffusion Sponsorisée • Maison Mirou (Chef & Dîner à Domicile)',
    targetEntityId: 'ad-mirou-diner-domicile',
    targetEntityType: 'ad',
    targetEntityName: 'Maison Mirou • Chef Privé & Dîner à Domicile',
    dateIssued: '2026-01-01',
    startDate: '2026-01-01',
    endDate: '2026-12-31',
    durationMonths: 12,
    durationLabel: '12 Mois (Pack Prestige Annuel)',
    provider: NISFY_PROVIDER_PARTY,
    client: {
      role: 'client',
      entityName: 'Maison Mirou Gourmet SARL / Chef Amira Khelifi',
      entityNameAr: 'دار ميرو للطهي الفاخر • الشيف أميرة خليفي',
      representativeName: 'Amira Khelifi (Chef Fondatrice & Directrice)',
      legalStatus: 'SARL',
      rcNumber: '16/00-9842101B24',
      nifNumber: '002416098421015',
      address: 'Boulevard du 11 Décembre 1960, El Biar, Alger',
      wilaya: '16 - Alger',
      phone: '+213 555 42 19 80',
      email: 'contact@maison-mirou.dz',
    },
    subjectFr: 'Diffusion sponsorisée et certification officielle du service traiteur & chef privé à domicile Maison Mirou sur les espaces Réceptions, Mariage, Dîners et Marketplace de l\'application NISFY.',
    subjectAr: 'النشر الإشهاري والتوثيق الرسمي لخدمة الشيف المنزلي الفاخر دار ميرو عبر تطبيق نصف دينك.',
    payment: {
      totalAmount: '360 000 DZD',
      monthlyAmount: '30 000 DZD / mois',
      currency: 'DZD',
      paymentMethods: ['baridimob', 'virement_cib'],
      schedule: 'annuel_avance',
      gracePeriodDays: 5,
      bankDetails: 'CPA Alger Agence El Biar : 004 00123 4567890123 44 / BaridiMob: 00799999001999990045',
    },
    termination: {
      noticePeriodDays: 30,
      immediateTerminationReasons: ['Non-respect des normes sanitaires HACCP', 'Atteinte à l’image de marque'],
      refundPolicy: 'Non remboursable après début de diffusion.',
    },
    articles: STANDARD_CONTRACT_ARTICLES.map((a) => ({ ...a, isVerified: true })),
    allArticlesVerified: true,
    status: 'signed_active',
    providerSigned: true,
    providerSignDate: '2026-01-02',
    clientSigned: true,
    clientSignDate: '2026-01-02',
    officialSealApplied: true,
    internalAdminNotes: 'Partenaire Officiel Chef à Domicile & Dîners d’Exception Nisfy. Dossier légal, certifications culinaires et paiement vérifiés.',
